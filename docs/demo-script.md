...
4. Use the example app at `fixtures/bad-app` — a vibe-coded-looking Next.js
   app that scores 30/100. Do not "improve" it; the low score is the demo.
